                ...
                {icon ??
                    {
                        ...
                        warn: <AlertTriangleIcon className="text-card fill-orange-500 w-5 h-5" />,
                        error: <AlertOctagonIcon className="text-card fill-red-500 w-5 h-5" />
                    }[type]}
                <div className="flex-1 w-0">
                    {title && <div className="text-card-foreground font-medium mb-0.5">{title}</div>}
